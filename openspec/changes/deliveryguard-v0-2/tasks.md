...
- [x] Register the v0.2.0 requirement and version facts without source, acceptance, deployment, or release claims.
- [x] Add and validate the provider-neutral request-diagnosis skill.
- [x] Add and validate the cross-platform real-device skill and its Android and iOS runbooks.
- [x] Mirror all new skill resources into the npm initializer.
