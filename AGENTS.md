...
- Keep repository-discoverable `.agents/skills` byte-for-byte synchronized with the packaged `templates/codex/.agents/skills` mirror; tests enforce this contract.
